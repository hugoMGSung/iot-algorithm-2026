...
표편집- [소스](./advanced/algorithm02/sol06-4-14/sol06-4-14.cpp)
...
![](assets/20260804_102048_image.png)

교재에서는 $O(N)$ 으로 설명. $O(N logN)$ 정도로 예상

#### 풀이 결과 예제

![](assets/20260804_103042_image.png)
...
- goal에 데이터가 없을때까지 반복
- cards1 에 맨앞데이터와 goal 맨앞데이터가 동일하면 cards1.pop(), goal.pop()
- cards2 에 맨앞데이터와 goal 맨앞데이터가 동일하면 cards2.pop(), goal.pop()
...
![](assets/20260805_140802_image.png)
...
- `제출 후 채첨하기` 때 출력문 주석처리 필요. 테스트 통과 실패(출력문 갯수 초과)
- unordered_map, map 둘 다 문제해결에 관계 없음

![](assets/20260806_104437_image.png)
...
![](assets/20260807_110323_image.png)
